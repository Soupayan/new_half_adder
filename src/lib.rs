//! This is a logic gate simulation crate built to demonstrate writing unit tests and integration tests
//! This also demonstrates the usage of Travis CI for continous testing
